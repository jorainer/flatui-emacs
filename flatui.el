...
;;; Credits
;;
;; Bozhidar Batsov for the flatui-emacs theme on which this code is based.
;;
;;; Code:
...
(defcustom flatui-distinct-doc-face nil
  "Make `font-lock-doc-face' stand out more."
  :type 'boolean
  :group 'flatui)

(defcustom flatui-use-variable-pitch t
  "Use variable pitch face for some headings and titles."
  :type 'boolean
  :group 'flatui)

(defcustom flatui-use-less-bold nil
  "Use bold weight less often."
  :type 'boolean
  :group 'flatui)

(defcustom flatui-use-more-italic nil
  "Use italic slant more often."
  :type 'boolean
  :group 'flatui)

(defcustom flatui-emphasize-indicators t
  "Use more colors for indicators such as git:gutter, flycheck and similar."
  :type 'boolean
  :group 'flatui)

(defcustom flatui-high-contrast-mode-line nil
  "Make the active/inactive mode line stand out more."
  :type 'boolean
  :group 'flatui)

(defcustom flatui-height-minus-1 0.8
  "Font size -1."
  :type 'number
  :group 'flatui)

(defcustom flatui-height-plus-1 1.1
  "Font size +1."
  :type 'number
  :group 'flatui)

(defcustom flatui-height-plus-2 1.15
  "Font size +2."
  :type 'number
  :group 'flatui)

(defcustom flatui-height-plus-3 1.2
  "Font size +3."
  :type 'number
  :group 'flatui)

(defcustom flatui-height-plus-4 1.3
  "Font size +4."
  :type 'number
  :group 'flatui)

(defcustom flatui-scale-org-headlines t
...
(defun flatui-color-name-to-rgb (color &optional frame)
...
(defun flatui-color-rgb-to-hex  (red green blue)
  "Return hexadecimal notation for the color RED GREEN BLUE.
RED, GREEN, and BLUE should be numbers between 0.0 and 1.0, inclusive."
  (format "#%02x%02x%02x"
          (* red 255) (* green 255) (* blue 255)))

(defun flatui-color-blend (color1 color2 alpha)
...
Alpha should be a float between 0 and 1."
  (apply 'flatui-color-rgb-to-hex
         (-zip-with '(lambda (it other)
                       (+ (* alpha it) (* other (- 1 alpha))))
                    (flatui-color-name-to-rgb color1)
                    (flatui-color-name-to-rgb color2))))
...
(defmacro flatui-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          ...
          (niagara      "#16a085")
          ;; bright alternatives for turquoise
          (riptide      "#86e2d5")
          (downy        "#65c6bb")
          ;; dark alternative for turquoise
          (lgreen-sea   "#1ba39c")
          ;; greens
          (emerald      "#2ecc71")
          (nephritis    "#27ae60")
          ...
          (cyan (if (eq variant 'light) lgreen-sea downy))
          ...
          (s-maybe-bold (if flatui-use-less-bold
                            'unspecified 'bold))
          (s-maybe-italic (if flatui-use-more-italic
                              'italic 'normal))
          (s-variable-pitch (if flatui-use-variable-pitch
                                'variable-pitch 'default))
          (s-fringe-bg (if flatui-distinct-fringe-background
                           base02 base03))
          (s-fringe-fg base01)
          ...
          (s-header-line-fg (if flatui-high-contrast-mode-line
                                base1 base0))
          (s-header-line-bg (if flatui-high-contrast-mode-line
                                base02 base03))
          (s-header-line-underline (if flatui-high-contrast-mode-line
                                       nil base02))

          (s-mode-line-fg (if flatui-high-contrast-mode-line
                              base03 base0))
          (s-mode-line-bg (if flatui-high-contrast-mode-line
                              base0 base02))
          (s-mode-line-underline (if flatui-high-contrast-mode-line
                                     nil s-line))

          (s-mode-line-buffer-id-fg (if flatui-high-contrast-mode-line
                                        'unspecified base1))
          (s-mode-line-inactive-fg (if flatui-high-contrast-mode-line
                                       base0 base01))
          (s-mode-line-inactive-bg (if flatui-high-contrast-mode-line
                                       base02 base03))
          (s-mode-line-inactive-bc (if flatui-high-contrast-mode-line
                                       base02 base02))
          )
     ,@body))

(defun create-flatui-theme (variant theme-name &optional childtheme)
...
;;; Color palette
  (flatui-with-color-variables variant
;;; Theme Faces
...
;;;;; font lock
                                ...
                                `(font-lock-doc-face ((,class (:foreground ,(if flatui-distinct-doc-face violet cyan)
                                                                           :slant ,s-maybe-italic))))
...
;;;;; auctex
                                ...
                                `(font-latex-slide-title-face ((,class (:inherit (,s-variable-pitch font-lock-type-face)
                                                                                 :weight bold :height ,flatui-height-plus-3))))
                                `(font-latex-string-face ((,class (:foreground ,cyan))))
                                `(font-latex-subscript-face ((,class (:height ,flatui-height-minus-1))))
                                `(font-latex-superscript-face ((,class (:height ,flatui-height-minus-1))))
...
;;;;; calfw
                                ...
                                `(cfw:face-title ((,class (:inherit ,s-variable-pitch :foreground ,yellow
                                                                    :weight bold :height ,flatui-height-plus-4))))
...
;;;;; custom
                                `(custom-face-tag ((,class (:inherit ,s-variable-pitch :height ,flatui-height-plus-3
                                                                     :foreground ,violet :weight normal))))
                                `(custom-variable-tag ((,class (:inherit ,s-variable-pitch
                                                                         :foreground ,cyan :height ,flatui-height-plus-3))))
                                `(custom-comment-tag ((,class (:foreground ,base01))))
                                `(custom-group-tag ((,class (:inherit ,s-variable-pitch :foreground ,blue :height ,flatui-height-plus-3))))
                                `(custom-group-tag-1 ((,class (:inherit ,s-variable-pitch :foreground ,red :height ,flatui-height-plus-3))))
...
;;;;; diff
                                ...
                                `(diff-refine-added
                                  ((((class color) (background light))
                                    (:background ,(flatui-color-blend "#ddffdd" green 0.7)))
                                   (((class color) (background dark))
                                    (:background ,(flatui-color-blend "#446644" green 0.7)))))
                                `(diff-refine-changed
                                  ((((class color) (background light))
                                    (:background ,(flatui-color-blend "#ddddff" blue 0.7)))
                                   (((class color) (background dark))
                                    (:background ,(flatui-color-blend "#444466" blue 0.7)))))
                                `(diff-refine-removed
                                  ((((class color) (background light))
                                    (:background ,(flatui-color-blend "#ffdddd" red 0.7)))
                                   (((class color) (background dark))
                                    (:background ,(flatui-color-blend "#664444" red 0.7)))))
...
;;;;;; alternative ediff (not finished)
                                ...
                                ;;                               :background ,(flatui-color-blend blue base03 0.25))
                                ;;                              )))
                                ;; `(ediff-fine-diff-B ((,class (
                                ;;                               :background ,(flatui-color-blend violet base03 0.25))
                                ;;                              )))
                                ;; `(ediff-fine-diff-C ((,class (
                                ;;                               :background ,(flatui-color-blend yellow base03 0.25))
                                ;;                              )))
                                ;; `(ediff-current-diff-A ((,class (
                                ;;                                  :background ,(flatui-color-blend blue base03 0.15)
                                ;;                                              ))))
                                ;; `(ediff-current-diff-B ((,class (
                                ;;                                   :background ,(flatui-color-blend violet base03 0.15)
                                ;;                                              ))))
                                ;; `(ediff-current-diff-C ((,class (
                                ;;                                  :background ,(flatui-color-blend yellow base03 0.15)
                                ;;                                              ))))
                                ;; `(ediff-even-diff-A ((,class (
                                ;;                                ;; :background ,(flatui-color-blend base0 base03 0.15)
                                ;;                               :background ,base02
                                ;;                               ;; :foreground ,base2
                                ;;                                ;; :background ,(flatui-color-blend green base02 0.15)
                                ;;                                           ))))
...
;;;;; flycheck
                                ...
                                `(flycheck-info
                                  ((,(append '((supports :underline (:style wave))) class)
                                    (:underline (:style wave :color ,(if flatui-emphasize-indicators
                                                                         blue base03)) :inherit unspecified))
                                   (,class (:foreground ,blue-hc :background ,blue-lc :weight bold :underline t))))
                                `(flycheck-fringe-error
                                  ((,class (:foreground ,(if flatui-emphasize-indicators
                                                             red-hc red)
                                                        :background ,(if flatui-emphasize-indicators
...
;;;;; git-gutter
                                `(git-gutter:added
                                  ((,class (:weight normal
                                                    :foreground ,(if flatui-emphasize-indicators
                                                                     green s-fringe-fg)
...
;;;;;; go-mode
                                ...
                                `(go-coverage-1 ((,class (:foreground ,(flatui-color-blend blue yellow (/ 2.0 6))))))
                                `(go-coverage-2 ((,class (:foreground ,(flatui-color-blend blue yellow (/ 3.0 6))))))
                                `(go-coverage-3 ((,class (:foreground ,(flatui-color-blend blue yellow (/ 4.0 6))))))
                                `(go-coverage-4 ((,class (:foreground ,(flatui-color-blend blue yellow (/ 5.0 6))))))
                                `(go-coverage-5 ((,class (:foreground ,blue))))
                                `(go-coverage-6 ((,class (:foreground ,(flatui-color-blend cyan blue (/ 2.0 6))))))
                                `(go-coverage-7 ((,class (:foreground ,(flatui-color-blend cyan blue (/ 3.0 6))))))
                                `(go-coverage-8 ((,class (:foreground ,(flatui-color-blend cyan blue (/ 4.0 6))))))
                                `(go-coverage-9 ((,class (:foreground ,(flatui-color-blend cyan blue (/ 5.0 6))))))
...
;;;;; hi-lock-mode
                                `(hi-yellow ((,class (:foreground ,(flatui-color-blend yellow base1 0.5)
                                                                  :background,(flatui-color-blend yellow base03 0.15)))))
                                `(hi-pink ((,class (:foreground ,(flatui-color-blend magenta base1 0.5)
                                                                :background,(flatui-color-blend magenta base03 0.15)))))
                                `(hi-green ((,class (:foreground ,(flatui-color-blend green base1 0.5)
                                                                 :background,(flatui-color-blend green base03 0.15)))))
                                `(hi-blue ((,class (:foreground ,(flatui-color-blend blue base1 0.5)
                                                                :background,(flatui-color-blend blue base03 0.15)))))
                                `(hi-black-b ((,class (:foreground ,base1
                                                                   :background ,base03
                                                                   :weight bold))))
                                `(hi-blue-b ((,class (:weight bold
                                                              :foreground ,(flatui-color-blend cyan base1 0.7)
                                                              :background ,(flatui-color-blend cyan base03 0.2)))))
                                `(hi-green-b ((,class (:weight bold
                                                               :foreground ,(flatui-color-blend green base1 0.7)
                                                               :background ,(flatui-color-blend green base03 0.2)))))
                                `(hi-red-b ((,class (:weight bold
                                                             :foreground ,(flatui-color-blend red base1 0.7)
                                                             :background ,(flatui-color-blend red base03 0.2)))))
...
;;;;;; headings and diffs
                                ...
                                `(magit-diff-hunk-heading
                                  ((t (:background ,(flatui-color-blend yellow base03 0.1)))))
                                `(magit-diff-hunk-heading-highlight
                                  ((t (:background ,(flatui-color-blend yellow base02 0.1)))))
...
;;;;; markdown-mode
                                ...
                                `(markdown-header-face-1 ((,class (:inherit ,s-variable-pitch :foreground , blue))))
                                `(markdown-header-face-2 ((,class (:inherit ,s-variable-pitch :foreground , violet))))
                                `(markdown-header-face-3 ((,class (:inherit ,s-variable-pitch :foreground , red))))
                                `(markdown-header-face-4 ((,class (:inherit ,s-variable-pitch :foreground , orange))))
                                `(markdown-header-face-5 ((,class (:inherit ,s-variable-pitch :foreground , yellow))))
...
;;;;; org-mode
                                `(org-agenda-structure
                                  ((,class (:foreground ,base1 :background ,base02
                                                        :weight bold :slant normal :inverse-video nil :height ,flatui-height-plus-1
                                                        :underline nil
                                ...
                                `(org-level-1 ((,class (:inherit ,s-variable-pitch :foreground ,blue
                                                                 ,@(when flatui-scale-org-headlines
                                                                     (list :height flatui-height-plus-3))))))
                                `(org-level-2 ((,class (:inherit ,s-variable-pitch :foreground ,violet
                                                                 ,@(when flatui-scale-org-headlines
                                                                     (list :height flatui-height-plus-2))))))
                                `(org-level-3 ((,class (:inherit ,s-variable-pitch :foreground ,red
                                                                 ,@(when flatui-scale-org-headlines
                                                                     (list :height flatui-height-plus-1))))))
                                ...
                                `(org-document-title ((,class (:foreground ,base1  :weight bold :height ,flatui-height-plus-4))))
...
;;;;; outline
                                ...
                                `(outline-3 ((,class (:inherit org-level-3 :height ,flatui-height-plus-2))))
                                `(outline-4 ((,class (:inherit org-level-4 :height ,flatui-height-plus-1))))
...
;;;;; powerline
                                ...
                                `(powerline-inactive1 ((,class ,(if flatui-high-contrast-mode-line
                                                                    `(:background ,base03 :foreground ,base1)
                                                                  `(:background ,base02 :foreground ,base01)))))
                                `(powerline-inactive2 ((,class ,(if flatui-high-contrast-mode-line
...
;;;;; smart-mode-line
                                ;; use (setq sml/theme nil) to enable Flatui for sml
...
;;;;; sx (WIP)
                                ...
                                ;; ensures readability as a bg for all flatui faces. If it's possible, that is.
...
;;;;;; headings
                                `(sr-active-path-face ((,class (:background ,blue :foreground ,base03
                                                                            :height ,flatui-height-plus-1  :weight bold))))
                                `(sr-editing-path-face ((,class (:background ,yellow :foreground ,base03
                                                                             :weight bold :height ,flatui-height-plus-1))))
...
;;;;; weather-metno
                                `(weather-metno-date ((,class (:foreground ,yellow :height ,flatui-height-plus-3))))
...
;;;;; highlight-symbol
                                ...
                                `(highlight-symbol-colors
                                  (--map (flatui-color-blend it ,base03 0.25)
...
;;;;; smartrep
                                `(smartrep-mode-line-active-bg (flatui-color-blend ,green ,s-mode-line-bg 0.2))
;;;;; term
...
;;;;; vc
                                `(vc-annotate-color-map
                                  '((20 . ,red)
                                    (40 . ,(flatui-color-blend yellow red (/ 2.0 4)))
                                    (60 . ,(flatui-color-blend yellow red (/ 3.0 4)))
                                    (80 . ,yellow)
                                    (100 . ,(flatui-color-blend green yellow (/ 2.0 6)))
                                    (120 . ,(flatui-color-blend green yellow (/ 3.0 6)))
                                    (140 . ,(flatui-color-blend green yellow (/ 4.0 6)))
                                    (160 . ,(flatui-color-blend green yellow (/ 5.0 6)))
                                    (180 . ,green)
                                    (200 . ,(flatui-color-blend cyan green (/ 2.0 6)))
                                    (220 . ,(flatui-color-blend cyan green (/ 3.0 6)))
                                    (240 . ,(flatui-color-blend cyan green (/ 4.0 6)))
                                    (260 . ,(flatui-color-blend cyan green (/ 5.0 6)))
                                    (280 . ,cyan)
                                    (300 . ,(flatui-color-blend blue cyan (/ 2.0 5)))
                                    (320 . ,(flatui-color-blend blue cyan (/ 3.0 5)))
                                    (340 . ,(flatui-color-blend blue cyan (/ 4.0 5)))
                                    (360 . ,blue)))
